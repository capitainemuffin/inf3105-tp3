...
for i in {1..4}; do 
	curl -o test"$i".txt --cookie "MoodleSessioncoursv3=$1;_shib_uqamidp=1" https://www.moodle2.uqam.ca/coursv3/pluginfile.php/2997192/mod_folder/content/0/test$i.txt?forcedownload=1
